...
Status: proposed, not built. Owner: practice lead. Drafted 2026-09-15, after Sprint 12.
...
|---|---|---|
| 13 | Scoring engine + prospects data; `/prospecting` Coverage and Targets views | Every account scores with visible components; coverage matrix shows gaps; engine tests pass |
