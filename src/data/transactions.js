...
const RAW = [
  ...
  { id: 'umg-pershing-proposal-2026', date: '2026-04-07', type: 'take-private', asset: 'equity', structure: 'equity', status: 'terminated',
    title: 'Pershing Square proposes $64.4B merger of UMG into NYSE-listed "New UMG"', acquirers: [E('pershing-square')], sellers: [E('umg')],
    value: 64.4e9, valueNote: '€55.8B; €5.05 cash + 0.77 New UMG shares per share; 78% premium', summary: "Non-binding; would have needed a two-thirds shareholder vote. UMG's board unanimously declined it on 29 May 2026 as materially undervaluing the company; no vote was held.",
    sources: [src('Pershing Square — proposal (Apr 2026)', 'https://www.businesswire.com/news/home/20260406138476/en/Pershing-Square-Announces-Proposal-to-Universal-Music-Group-N.V.'), src('UMG — board declines proposal (29 May 2026)', 'https://www.prnewswire.com/news-releases/universal-music-group-nv-board-of-directors-declines-unsolicited-pershing-square-proposal-302785944.html')] },
  ...
  { id: 'superstruct-kkr-2024', date: '2024-06', type: 'm&a', asset: 'equity', structure: 'equity',
    ...
    value: 1.4e9, valueNote: '~€1.3B; Providence holds a €250M reinvestment option', summary: '80+ festivals in 10 countries (Sziget, Wacken, Sónar).',
    sources: [src('KKR — Superstruct (Jun 2024)', 'https://www.businesswire.com/news/home/20240621755499/en/KKR-to-Acquire-Pan-European-Live-Entertainment-Group-Superstruct-from-Providence-Equity-Partners')] },
  { id: 'asm-legends-2024', date: '2024-08-23', type: 'm&a', asset: 'n/a', structure: 'cash',
    title: 'Legends completes acquisition of ASM Global', acquirers: [E('legends'), E('sixth-street')], sellers: [E('aeg'), P('Onex', 'fund')],
    value: 2.3e9, valueNote: '~$2.3B reported', summary: 'Announced Nov 2023; closed 23 Aug 2024 after DOJ review. Onex and AEG exited fully; ASM keeps its name.',
    sources: [src('Legends — completes acquisition of ASM Global', 'https://legendsglobal.com/legends-completes-acquisition-of-asm-global/')] },
...
export const TX_TOTALS = {
  ...
  disclosed: TRANSACTIONS.filter((t) => t.value && t.status !== 'terminated').reduce((s, t) => s + t.value, 0),
